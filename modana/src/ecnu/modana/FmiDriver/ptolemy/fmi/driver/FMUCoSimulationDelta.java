...
//            fBeta.simulate("E:\\fmusdk\\fmu20\\fmu\\cs\\E:\fmusdk\fmu20\fmu\cs\smartBuilding_roomA.fmu,E:\fmusdk\fmu20\fmu\cs\smartBuilding_roomB.fmu", 48, 0.01,
//                    false, _csvSeparator, _outputFileName);
        fBeta.simulate("E:\\fmusdk\\fmu20\\fmu\\cs\\smartBuilding_roomA.fmu,E:\\fmusdk\\fmu20\\fmu\\cs\\smartBuilding_roomB.fmu", 48,0.01,
                false, _csvSeparator, _outputFileName);
...
//                    fmiComponent, startTime, file, csvSeparator, Boolean.FALSE);
            ...
            double hcA_pre_temperature = 0;
            double hcA_pre_switch = 0;
            boolean hcA_pre_strategy = false;
            double hcB_pre_temperature = 0;
            double hcB_pre_switch = 0;
            boolean hcB_pre_strategy = false;
            boolean rj_pre_strategyA = false;
            boolean rj_pre_strategyB = false;
            boolean rj_pre_triggered = false;

            double current_Time = 0;
            double hcA_current_temperature = 0;
            double hcA_current_switch = 0;
            boolean hcA_current_strategy = false;
            double hcB_current_temperature = 0;
            double hcB_current_switch = 0;
            boolean hcB_current_strategy = false;
            boolean rj_current_strategyA = false;
            boolean rj_current_strategyB = false;
            boolean rj_current_triggered = false;
            System.out.println("initial time"+(System.currentTimeMillis()-start));
            ...
            while (time < endTime) {
                ...
                double tA = fmiModelDescriptions[0].modelVariables.get(0).getDouble(fmiComponent[0]);
                double needB = fmiModelDescriptions[0].modelVariables.get(3).getDouble(fmiComponent[0]);
                double tB = fmiModelDescriptions[1].modelVariables.get(0).getDouble(fmiComponent[1]);
                double needA = fmiModelDescriptions[1].modelVariables.get(3).getDouble(fmiComponent[1]);
                //data exchange
...
//            invoke("fmi2Terminate", new Object[] { fmiComponent[0] },
