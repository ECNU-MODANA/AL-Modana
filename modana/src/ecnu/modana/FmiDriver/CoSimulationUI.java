...
//			    	toolSlave.put("ecnu.modana.FmiDriver.HumansActivity","SourceCode");
			    	...
			    	//new PlugCoSimulation().CoSimulation(fmus, toolSlave, null, 0, 50, 0.04, "./files/res.csv");
			    	new CosimulationMaster().CoSimulation(fmus, toolSlave, null, 
			    			0, 10, 1,1, "./files/res.csv");
