...
///**
// * @Authorï¼? AoYi
// * @Description:step revision Master Algorithm for co-simulation
// * @Created by oe on 2018/3/14.
// */
//public class StepRevisionCosimulationMaster extends FMUDriver {
//    private final boolean showResult;
//    private final boolean showTimeConsumption;
//    private final boolean showPartion;
//    public StepRevisionCosimulationMaster(boolean sr, boolean stc, boolean sp){
//        showResult = sr;
...
//            ecnu.modana.FmiDriver.Room room = new ecnu.modana.FmiDriver.Room(5);
//            room.NewPath();
...
//                }
//            }
//            ecnu.modana.FmiDriver.HeaterController heaterController_roomA = new ecnu.modana.FmiDriver.HeaterController(1);
//            ecnu.modana.FmiDriver.HeaterController heaterController_roomB = new ecnu.modana.FmiDriver.HeaterController(1);
...
//                }
//                ecnu.modana.FmiDriver.SmartBuildingTestBand.plotArray.  add(time_plot);
//            }
//            if(showPartion) {
//                for (int j = 0; j < 3; j++) {
