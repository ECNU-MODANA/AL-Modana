...
public class PrismCL implements PrismModelListener
{
	...
	{
//		Server.log.println("start run:");
//		if(null!=args&&args.length>0) 
//		{
//			Server.log.println(args[0]+args.length);
//			for(int i=0;i<args.length;i++)
//				Server.log.println(args[i]);
//		}
		if(null!=args&&args.length==1&&"startserver".equals(args[0]))
		{
			Server.getInstance().StartServer();
			return;
		}
		if(null!=args&&args.length==1&&"endserver".equals(args[0]))
		{
