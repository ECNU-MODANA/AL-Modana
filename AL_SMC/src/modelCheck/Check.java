...
//					     		 System.out.println(stateList.get(i).getValue(exVList.get(j))+"============打印属性值"+exVList.get(j));
...
//					     		 System.out.println(stateList.get(i).getValue(exVList.get(j))+"============打印属性值"+exVList.get(j));
								 String op =  exOList.get(j);
								 if (op.equals("==")) {
									 if (Double.valueOf(exNList.get(j))==(double)state.getValue(exVList.get(j))) {
											flag.add(true);
									 }
									 else{
										 flag.add(false);
									...
									if ((double)state.getValue(exVList.get(j))<Double.valueOf(exNList.get(j))) {
										flag.add(true);
									}
									else{
										flag.add(false);
